...
// ⚡ FIX 1: Switched to 1.5-flash for better free tier stability
...
app.post('/enhance', async (req, res) => {
  try {
    ...
    // ⚡ FIX 2: Unified "Master Prompt" (1 Request instead of 3) to save Quota
    const masterPrompt = `
    ...
    if (error.message === 'Request timeout') {
      return res.status(408).json({
        enhanced: "⚠️ Request timed out. The AI is taking too long."
      });
    }
